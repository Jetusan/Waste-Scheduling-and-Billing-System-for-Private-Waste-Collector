...
const enhancedReportsRouter = require('./routes/enhancedReports');
...
app.use('/api/admin/late-fees', lateFeesRouter); // Add late fees management routes
...
app.use('/api/reports', enhancedReportsRouter);
