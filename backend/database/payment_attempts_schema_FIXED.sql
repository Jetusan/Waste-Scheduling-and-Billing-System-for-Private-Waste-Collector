...
DO $$
BEGIN
  RAISE NOTICE '✅ Payment attempts schema installed successfully!';
  RAISE NOTICE '📊 Created: payment_attempts table';
  RAISE NOTICE '🔧 Added: payment tracking columns to customer_subscriptions and users';
  RAISE NOTICE '⚡ Installed: automatic triggers for scoring and suspension';
